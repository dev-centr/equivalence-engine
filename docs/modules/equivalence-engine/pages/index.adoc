...
* xref:equivalence-engine-action:index.adoc[Equivalence Engine Action] (link:https://github.com/dev-centr/equivalence-engine-action[repo]): reusable GitHub Action that runs adaptations in CI.
* xref:libequivalence:index.adoc[libequivalence] (link:https://github.com/dev-centr/libequivalence[repo]): core D library for rules parsing and path resolution, consumed by the CLI.
* xref:equivalence-rules-code:index.adoc[Equivalence Rules: Code] (link:https://github.com/dev-centr/equivalence-rules-code[repo]): official rulesets for source files (e.g. PyQt5 to PyQt6).
* xref:equivalence-rules-filesystem:index.adoc[Equivalence Rules: Filesystem] (link:https://github.com/dev-centr/equivalence-rules-filesystem[repo]): mappings for abstract folder intents across operating systems.
